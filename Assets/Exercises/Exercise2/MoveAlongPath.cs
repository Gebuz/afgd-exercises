...
namespace AfGD
{
    ...
    public class MoveAlongPath : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            // rotate the cube to be parallel with the tangent vector
            Vector3 rot = path.Evaluate(s, parameterizeByArclength, 1);
            this.transform.rotation = Quaternion.LookRotation(rot, Vector3.up);
